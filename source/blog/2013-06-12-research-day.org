...
** Don't Work Production Code Into Research
   ...
   Here's an example: let's say you want to research [[http://lesscss.org/][less]] to CSS
   ...
   evaluate that is wrong, or your system? Also, remember, you just
   wasted 75 minutes you could have used more productively exploring
   all the options or the other choices of less to CSS engine.
...
** Make Research Day All-Day
   ...
   more effective. I also found I was less likely to give up the time
   to do production work when something small came up.
